...
with open('test8.txt', 'r') as test_8:
    L_8 = int(test_8.readline())
    details_length_8 = [int(i) for i in test_8.readline().split()]
    details_price_8 = [int(i) for i in test_8.readline().split()]

with open('test9.txt', 'r') as test_9:
    L_9 = int(test_9.readline())
    details_length_9 = [int(i) for i in test_9.readline().split()]
    details_price_9 = [int(i) for i in test_9.readline().split()]

with open('test10.txt', 'r') as test_10:
    L_10 = int(test_10.readline())
    details_length_10 = [int(i) for i in test_10.readline().split()]
    details_price_10 = [int(i) for i in test_10.readline().split()]
...
print("TEST 8:", '\n')
print("INPUT DATA:")
print("Length of initial material -", L_8)
print("Details lengths - ", details_length_8)
print("Details prices -  ", details_price_8, '\n')

temp_profit, temp_details_counter, temp_detail_number = DP(L_8, details_length_8, details_price_8)

print("Dynamic programming:")
print("The profit of optimal cutting: ", temp_profit[L_8])
for i in range(len(details_length_8)):
    if temp_details_counter[i] != 0:
        print("Number of details of", i + 1, "type:", temp_details_counter[i])
print()

temp_profit, temp_details_counter = Heuristic(L_8, details_length_8, details_price_8)
print("Heuristic algorithm:")
print("The profit of optimal cutting: ", temp_profit)
for i in range(len(details_length_8)):
    if temp_details_counter[i] != 0:
...
print("TEST 9:", '\n')
print("INPUT DATA:")
print("Length of initial material -", L_9)
print("Details lengths - ", details_length_9)
print("Details prices -  ", details_price_9, '\n')

temp_profit, temp_details_counter, temp_detail_number = DP(L_9, details_length_9, details_price_9)

print("Dynamic programming:")
print("The profit of optimal cutting: ", temp_profit[L_9])
for i in range(len(details_length_9)):
    if temp_details_counter[i] != 0:
        print("Number of details of", i + 1, "type:", temp_details_counter[i])
print()

temp_profit, temp_details_counter = Heuristic(L_9, details_length_9, details_price_9)
print("Heuristic algorithm:")
print("The profit of optimal cutting: ", temp_profit)
for i in range(len(details_length_9)):
    if temp_details_counter[i] != 0:
...
print("TEST 10:", '\n')
print("INPUT DATA:")
print("Length of initial material -", L_10)
print("Details lengths - ", details_length_10)
print("Details prices -  ", details_price_10, '\n')

temp_profit, temp_details_counter, temp_detail_number = DP(L_10, details_length_10, details_price_10)

print("Dynamic programming:")
print("The profit of optimal cutting: ", temp_profit[L_10])
for i in range(len(details_length_10)):
    if temp_details_counter[i] != 0:
        print("Number of details of", i + 1, "type:", temp_details_counter[i])
print()

temp_profit, temp_details_counter = Heuristic(L_10, details_length_10, details_price_10)
print("Heuristic algorithm:")
print("The profit of optimal cutting: ", temp_profit)
for i in range(len(details_length_10)):
    if temp_details_counter[i] != 0:
...
#--------------------------------------------------------------
    ...
    t_start = timeit.default_timer()
    Heuristic(L_8, details_length_8, details_price_8)
    t_stop = timeit.default_timer()
    time8_Heuristic += t_stop - t_start

    t_start = timeit.default_timer()
    Heuristic(L_9, details_length_9, details_price_9)
    t_stop = timeit.default_timer()
    time9_Heuristic += t_stop - t_start

    t_start = timeit.default_timer()
    Heuristic(L_10, details_length_10, details_price_10)
    t_stop = timeit.default_timer()
    time10_Heuristic += t_stop - t_start
...
t_start = timeit.default_timer()
DP(L_8, details_length_8, details_price_8)
t_stop = timeit.default_timer()
time8_DP += t_stop - t_start

t_start = timeit.default_timer()
DP(L_9, details_length_9, details_price_9)
t_stop = timeit.default_timer()
time9_DP += t_stop - t_start

t_start = timeit.default_timer()
DP(L_10, details_length_10, details_price_10)
t_stop = timeit.default_timer()
time10_DP += t_stop - t_start
...
print("Average execution time:\n",
      ...
      "|DP test 8|: ", '%.6f' % (time8_DP), "\n",
      "|DP test 9|: ", '%.6f' % (time9_DP), "\n",
      "|DP test 10|: ", '%.6f' % (time10_DP), "\n", "\n",
      ...
      "|Heuristic test 8|: ", '%.6f' % (time8_Heuristic / 100), "\n",
      "|Heuristic test 9|: ", '%.6f' % (time9_Heuristic / 100), "\n",
      "|Heuristic test 10|: ", '%.6f' % (time10_Heuristic / 100))
